...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dl_story', 'source', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dl.Source']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.source'
        db.delete_column('dl_story', 'source_id')
    ...
    models = {
        ...
        'dl.story': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dl.Source']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 14, 3, 55, 605275)'}),
