...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.short_name'
        db.add_column('dl_source', 'short_name', self.gf('django.db.models.fields.CharField')(default='-', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.short_name'
        db.delete_column('dl_source', 'short_name')
    ...
    models = {
        ...
        'dl.story': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dl.Source']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 7, 22, 10, 25, 895407)'}),
